...
class CNetAddr
{
    ...
    public:
        ...
        bool IsIPv6() const;    // IPv6 address (not mapped IPv4)
...
bool Lookup(const char *pszName, CService& addr, int portDefault = 0);
bool Lookup(const char *pszName, std::vector<CService>& vAddr, int portDefault = 0, unsigned int nMaxSolutions = 0);
